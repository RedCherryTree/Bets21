...
public class DeleteEventGUI extends JFrame {
	...
	private JTextField jTextFieldDeleteEvent = new JTextField();
	...
	private JButton jButtonDeleteEvent = new JButton(ResourceBundle.getBundle("Etiquetas").getString("DeleteEvent"));
	...
	public DeleteEventGUI(Vector<domain.Event> v) {
		try {
			jbInit(v);
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jTextFieldDeleteEvent.setBounds(new Rectangle(100, 211, 429, 20));

		jCalendar.setBounds(new Rectangle(40, 50, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonDeleteEvent.setBounds(new Rectangle(100, 275, 130, 30));
		jButtonDeleteEvent.setEnabled(true);

		jButtonDeleteEvent.addActionListener(new ActionListener() {
		...
		this.getContentPane().add(jButtonDeleteEvent, null);
		this.getContentPane().add(jTextFieldDeleteEvent, null);
